module Spree
  class Gateway::Afterpay < Gateway
    ...
    def billing_address(order)
      ...
      { name: billing.full_name, line1: billing.address2, suburb: billing.state.name, state: billing.state.name, postcode: billing.zipcode, countryCode: billing.country.iso, phoneNumber: billing.phone.to_s }
    end
